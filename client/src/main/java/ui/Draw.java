            ...
            for (var row : rowNums) {
                ...
                for (var col : colNums) {
                    ...
                    if (piece != null) {
                        ...
                        var piecePrintColor = (pieceColor.equals("WHITE")) ? SET_TEXT_COLOR_BLUE : SET_TEXT_COLOR_RED;
                        var pieceText = pieceMap.get(pieceColor + "_" + pieceType);
                        stringBuilder.append(squareColor).append(piecePrintColor).append(pieceText).append(RESET_BG_COLOR).append(RESET_TEXT_COLOR);
                    } else {
